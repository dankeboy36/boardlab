...
BoardLab is a VS Code extension that aims to be feature-complete with Arduino IDE 2.x, while staying fully open, power-user friendly, and strictly native to VS Code’s UX.
